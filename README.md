...
- [📍 Résumé](#-résumé)
- [🛠️ Outils et services](#️-outils-et-services)
...
2. Ce connecter sur [azure-portal](https://portal.azure.com/#view/Microsoft_AAD_IAM/StartboardApplicationsMenuBlade/~/AppAppsPreview) et créer une [application](https://learn.microsoft.com/en-us/graph/auth-register-app-v2).
